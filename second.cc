...
main(int argc, char* argv[])
{
    ...
    AsciiTracserHelper ascii;
    pointToPoint.EnableAsciiAll(ascii.CreateFileStream("ICp2p.tr"));
    csma.EnableAsciiAll(ascii.CreateFileStream("ICcsms.tr"))
    ...
    pointToPoint.EnablePcapAll("IC_p2p");
    csma.EnablePcap("ICcsma", csmaDevices.Get(1), true);
    
    //Create Net anim file
    AnimationInterface anim("IC.xml");
